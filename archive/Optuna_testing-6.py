...
# In[ ]:
# Version 6. Added name variable to better save and organize results.
...
name = "RF_extracted_scaled_w_modified_labels_01"
data = formatrix.DataCurator("./RF_extracted_features_modified-labels.csv")
...
def objective(trial):
    ...
    for epoch in range(n_epochs):
        ...
        train(model, optimizer, 'epoch_'+str(epoch))  # Train the model
